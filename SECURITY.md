...
- **Quality Gate:** treats compiler warnings as errors, runs tests with coverage, executes the preference fuzzer corpus under Undefined Behavior Sanitizer, performs Xcode static analysis, and validates a universal macOS 14+ release build.

...
- **Quality Gate:** treats compiler warnings as errors, runs tests with coverage, executes the preference fuzzer corpus concurrently under Thread Sanitizer, performs Xcode static analysis, and validates a universal macOS 14+ release build.

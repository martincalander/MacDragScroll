...
The first update from `1.1.0` or earlier to `1.2.0` requires one final Accessibility and Input Monitoring grant. Normal updates after that retain the same macOS code identity and should not reset either permission.
